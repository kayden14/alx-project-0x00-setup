...
import STAR_IMAGE from "@/public/assets/images/star.jpg";
    ...
    <div className="h-[422px] w-[378.56px] cursor-pointer hover:shadow-md hover:rounded-lg ">
      ...
      <div className="flex justify-between mt-4">
        <div className="grid grid-cols-3 border w-[156px] rounded-full px-2 py-1">
          {/* Icons & text for metadata (beds, bathrooms, guests) */}
          {/* This part was truncated, ensure you include all svg + text blocks here */}
        </div>
